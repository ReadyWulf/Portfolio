/// @desc provides all of the necessary variables to add springs to any object. EXT - allows for manually establishing of parameters
...
array[0] = argument2;//Rest Length
array[1] = argument3;//Time step
array[2] = argument0;// x equilibrium position(anchors)
array[3] = argument1;// y
array[4] = argument4;//mass of bob
array[5] = argument5;//spring constant(k)
array[6] = argument6;//damping constant
array[7] = argument7;//x gravitaional constant(g(x))
array[8] = argument8;//y gravitaional constant(g(y))
...
array[46] = 0;// max x/y
array[47] = 0;
array[48] = 1;// debug mode - 0 is off - 1 is on
